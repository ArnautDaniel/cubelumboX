...
cubelumboX: raylib
ifneq (,$(cubelumboX_config))
	@echo "==== Building cubelumboX ($(cubelumboX_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f cubelumboX.make config=$(cubelumboX_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f cubelumboX.make clean
